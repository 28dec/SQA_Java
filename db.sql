...
INSERT INTO `rule` VALUES (1,15,17,10,8,4700000,4500000,4100000,3700000,0,'2019-03-15 20:39:01'),(2,16,17,10,8,4700000,4500000,4100000,3700000,0,'2019-03-21 09:05:48'),(15,15,17,10,8,4700000,4500000,4100000,3700000,0,'2019-03-21 09:41:18');
...
BEGIN
	select count(*) as `result` from company;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	select count(*) as `result` from customer where `type_of_insurance` = 'VOLUNTARY' and code not in (select `customer_code` from insurance where pay_date >= STR_TO_DATE(concat('01/',_from_date), '%d/%m/%Y') and pay_date <= STR_TO_DATE(concat('01/',_to_date), '%d/%m/%Y') and `type_of_insurance` = 'VOLUNTARY');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	select sum(salary) as `result` from salary where customer_code in (select customer_code from customer where customer_code not in (select customer_code from insurance where STR_TO_DATE(concat('01/', _from_date), '%d/%m/%Y') <= pay_date and pay_date <= STR_TO_DATE(concat('01/', _to_date), '%d/%m/%Y') and `type_of_insurance` = 'VOLUNTARY'));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `search_customer_by_code` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `search_customer_by_code`(in _code varchar(50))
BEGIN
	select `full_name` from customer where `code` = _code;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `search_customer_by_name` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `search_customer_by_name`(in _name varchar(255))
BEGIN
	select `id`, `code`, `full_name`, `date_of_birth`
    from customer
    where `full_name` like concat('%', _name, '%');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-04-08  0:41:32
