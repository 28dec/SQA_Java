        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    % lương người lao động đóng BHBB<input type="text" name="labor_CSI_percentage" class="input_in_setting_popup" id="input_labor_VSI_percentage"> <button class="btn_in_setting_popup" value="input_labor_VSI_percentage">SỬA</button><br>
                    % lương người lao động đóng BHTN<input type="text" name="labor_VSI_percentage" class="input_in_setting_popup" id="input_labor_CSI_percentage"> <button class="btn_in_setting_popup" value="input_labor_CSI_percentage">SỬA</button><br>
